...
`Snow.deaths2`: An alternative version of `Snow.deaths` correcting some
possible duplicate and missing cases, as described in
[`vignette("Snow_deaths-duplicates")`](https://friendly.github.io/HistData/articles/Snow_deaths-duplicates.md).

`Snow.dates`: A data frame of 44 observations and 3 variables from Table
1 of Snow (1855), giving the number of fatal attacks and number of
...
[data-viz-projects](https://github.com/nrennie/data-viz-projects), a
tour-de-force: [John Snow's Cholera
Maps](https://github.com/nrennie/data-viz-projects/blob/main/john-snow-cholera-map/john-snow-cholera-maps.R)
...
for code to draw Snow's map;
[`Cholera`](https://friendly.github.io/HistData/reference/Cholera.md)
for William Farr's cholera data. The cholera package contains more
analytical methods for understanding Snow's cholera data.
