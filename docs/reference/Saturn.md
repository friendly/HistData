...
[`Mayer`](https://friendly.github.io/HistData/reference/Mayer.md) had.
Indeed, it was Laplace's generalization that enjoyed popularity
throughout the first half of the nineteenth century, as a method that
provided some of the accuracy expected from least squares, with much
