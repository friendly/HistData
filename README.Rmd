...
* **Provenance**: Where possible, a dataset's documentation traces a clear path from its original
source to the version shipped here -- not just "digitized from X," but *how*, and what's still
unverified. `Perozzo` is a case in point: its immediate source (a GitHub redraw of the stereogram)
was traced and confirmed byte-identical, but the actual digitization from Perozzo's 1880/1881
plate remains unknown -- and the documentation says so, rather than implying more confidence than
the data warrants.
