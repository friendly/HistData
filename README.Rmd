...
Some similar considerations apply to the **values* of character or factor variables in a dataset, and also how these will be ordered in tabular or graphic displays. As one example, levels of education, with values
`"Low"`, `"Medium"`, `"High"` will be sorted H, L, M by default. You can recode or assign levels
`c("1:Low", "2:Medium", "3:High")` or create them as `ordered()` factors.
