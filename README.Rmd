...
alas (for teaching what's involved in this) not captured in the resulting CRAN-friendly package.

* In some cases, data had to be **extracted** from historical documents, using a variety of techniques (web scraping, OCR of PDF files followed by conversion to a data set), each problem with its own toolbox, in R or outside. In many cases, transcription errors had to be corrected 
...
* **package maintenance**: Originally, I wrote most of the documentation using `utils::prompt()` ...
