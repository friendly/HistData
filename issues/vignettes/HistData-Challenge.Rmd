...
it recurs, unchanged, thirty years later. The dotted line marks the shared level and -- following
Zabell & Wainer's own Figure 2 [-@ZabellWainer:2002] -- shows it passing through only these two
points:
...
ggplot(Arbuthnot, aes(x = Year, y = Christenings)) +
  ...
  annotate(
    "segment", x = 1675, xend = 1703, y = copy_level, yend = copy_level,
...
thumb." That he apparently never did is itself the historiographic finding, not a personal
failing: it's evidence that graphing data simply wasn't yet part of a statistician's toolbox in
1710. Re-visioning the graph doesn't just fix a 300-year-old data error; it exposes a working
