...
Citations now resolve via [@key]/histdata.bib (as of 2026-08-24) -- the vignette YAML header
above and the bibliography wiring are done. Still to do before this ships:
  1. git mv issues/vignettes/HistData-Challenge.Rmd vignettes/HistData-Challenge.Rmd (bring
     histdata.bib along too)
  2. devtools::document(); devtools::check(); NEWS.md entry; rebuild pkgdown
