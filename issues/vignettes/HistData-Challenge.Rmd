...
When this is ready to ship:
  1. Add a proper vignette YAML header (rmarkdown::html_vignette + %\VignetteIndexEntry etc.),
     including `bibliography: histdata.bib` -- the file already exists
     (issues/vignettes/histdata.bib, verified with pandoc --citeproc) and switch citations below
     to [@key] form
...
- Hanley, Julien & Moodie (2008), "Student's z, t, and s: What if Gosset had R?," traces the
...
- Hanley, J., Julien, M., & Moodie, E. (2008). Student's z, t, and s: What if Gosset had R? *The
  American Statistician*, 62(1), 64-69.
